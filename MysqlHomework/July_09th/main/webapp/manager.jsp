...
<!-- main begin-->
 <div class="main">
   <div class="sidebarg fnone">
     <form action="manager.do" method="post" target='_blank'>
    <div class="login">
      <dl>
        <dt>管理员登陆</dt>
        <dd><label for="name">用户名：</label><input type="text" name="managerusername" class="inputh" value="常用邮箱" id="name"/></dd>
        <dd><label for="password">密 码：</label><input type="text" name="password" class="inputh" value="密码" id="password"/></dd>
        <dd>
